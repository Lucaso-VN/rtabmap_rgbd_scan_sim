 #ifndef NAV2_PSO_PLANNER__PSO_HPP_
 #define NAV2_PSO_PLANNER__PSO_HPP_
 ...
 namespace nav2_pso_planner
 {
   ...
   public:
    ...
    double w_social, double w_cognitive, double obs_factor, int max_speed,
   ...
   protected:
     ...
     int pso_max_iter_;            			// maximum iterations
 ...
 #endif //NAV2_PSO_PLANNER__PSO_HPP_
